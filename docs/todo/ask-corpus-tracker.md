...
| R1 | Query rewriting (HyDE / step-back) per facet | 1 | skill | todo | — | — | facet → distinct `retrieval_query` in subagent brief; weak-query spot-checks improve; citations stay against original claims | bratanic_2025 Ch.3 | — | n/a (pre-eval) | |
| O1 | Intent-based retriever routing v1 | 1 | skill | todo | — | — | intent→strategy table in SKILL.md; 4-intent smoke set shows per-intent tool emphasis | bratanic_2025 Ch.5; arsanjani_2026 Ch.5 | — | n/a (pre-eval) | `global` intent label is the hook for O1b |
| O2 | Answer-critic re-retrieval loop (Phase 3b) | 1 | skill | todo | — | — | 1-round cap; gap-facet triggers exactly one re-retrieval; all-high-confidence adds zero cost; skipped in --fast | bratanic_2025 Ch.5; gulli_2025 Ch.4 | — | n/a (pre-eval) | |
